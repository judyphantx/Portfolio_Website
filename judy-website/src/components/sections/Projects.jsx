        ...
        <div className="mt-12 text-center">
          <div className="bg-gray-900/30 backdrop-blur-sm rounded-xl p-6 border border-gray-700">
            ...
            <p className="text-gray-300 mb-4">
              ...
              technologies. Check back soon for updates!
            </p>
            <div className="flex justify-center gap-4">
              <button className="bg-blue-500/10 hover:bg-blue-500/20 text-blue-400 px-6 py-2 rounded-lg transition-all border border-blue-500/20 hover:border-blue-500/40">
                View GitHub
              </button>
              <button className="bg-purple-500/10 hover:bg-purple-500/20 text-purple-400 px-6 py-2 rounded-lg transition-all border border-purple-500/20 hover:border-purple-500/40">
                Contact Me
              </button>
            </div>
          </div>
